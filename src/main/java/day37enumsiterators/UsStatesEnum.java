...
public enum UsStatesEnum {
    ...
    /*
     ...
     1) Enumlar sabit datalari depolamak icin kullanilir.
     2) ALABAMA ("Alabama", "AL", "Montgomery") böyle bir Enum olusturdugunuzda ;
          mutlaka parentez icindeki datalari koymak icin mutlaka private final  variable'lar olusturmalisiniz.
    ...
    MINNESOTA ("Minnesota", "MN", "St. Paul"),
    ...
    // Parantez icerisine koydugumuz kadar variable olusturulur
    ...
    // State'in kisaltmasini verince State veren method.
    ...
    // State  verince State'in kisaltmasini veren method.
